...
export default function FilterButton() {
  ...
  const queryString = Object.entries(wholeObj)
    ...
    .map(([key, value]) => {
      ...
      return `apartmentSpecification.${encodeURIComponent(
        key
        ...
        <DialogContent>
          ...
          >
            ...
            <Grid sx={{ display: "flex" }}>
              <CustomGrid bgcolor="#000" color="white">
                Any
              </CustomGrid>
        ...
        <DialogContent>
          <Box sx={{ display: "flex" }}>
            <FormGroup sx={{ width: "50%" }}>
              <FormControlLabel
                control={
                  <Checkbox name="hasPool" onChange={handleCheckboxChange} />
                }
                label="Pool"
              />
              <FormControlLabel
                control={
                  <Checkbox name="hasHotTub" onChange={handleCheckboxChange} />
                }
                label="Hot tube"
              />
              <FormControlLabel
                control={
                  <Checkbox name="hasPatio" onChange={handleCheckboxChange} />
                }
                label="Patio"
              />
              <FormControlLabel
              ...
              <FormControlLabel
                control={
                  <Checkbox name="hasFirePit" onChange={handleCheckboxChange} />
                }
                label="Fire Pit"
              />
              <FormControlLabel
            ...
            <FormGroup sx={{ width: "50%" }}>
              ...
              <FormControlLabel
                control={
                  <Checkbox name="hasPiano" onChange={handleCheckboxChange} />
                }
                label="Piano"
              />
              <FormControlLabel
                control={<Checkbox name="hasExerciseEquipment" />}
        ...
        <DialogContent>
          <Box sx={{ display: "flex" }}>
            <FormGroup sx={{ width: "50%" }}>
              <FormControlLabel
                control={
                  <Checkbox name="hasWifi" onChange={handleCheckboxChange} />
                }
                label="Wifi"
              />
              <FormControlLabel
                control={
                  <Checkbox name="hasTv" onChange={handleCheckboxChange} />
                }
                label="TV"
              />
              <FormControlLabel
                control={
                  <Checkbox name="hasWasher" onChange={handleCheckboxChange} />
                }
                label="Washer"
              />
              <FormControlLabel
